...
/**
 * Classe technique gérant l'arborescence des dossiers par Joueur
 * et la sérialisation/désérialisation du Personnage (.ser).
 */
public class GestionnaireSauvegarde implements Serializable {
    ...
    /**
     * Crée le dossier du joueur s'il n'existe pas encore.
     * Initialise aussi le fichier de stats à 0.
