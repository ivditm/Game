 ...
 * non-directionnelle (QUITTER, AIDE, RETOUR, etc.). Chaque commande possède une
 * **abréviation** et une **description complète**.
 * <p>
...
public interface Commande {
	...
	/**
	 * Fusionne toutes les commandes directionnelles et non-directionnelles pour
	 * simplifier la génération de listes.
	 */
